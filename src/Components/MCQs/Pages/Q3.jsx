...
const Q3 = () => {
  ...
  return (
    <div className='MCQs-Q-Main'>
      <h1 className='MCQs-Q-H1'>If you had arrived late, I ………………….. angry.</h1>
      <div className='MCQs-Q-img1'></div>
      <div className='MCQs-Q-Buttons1'>
        <button onClick={handleClick2} className='MCQs-Q-Button'>A.had been</button>
        <button onClick={handleClick2} className='MCQs-Q-Button'>B.will be</button>
      </div>
      <div className='MCQs-Q-Buttons2'>
        <button onClick={handleClick2} className='MCQs-Q-Button'>C.will have been</button>
        <button onClick={handleClick} className='MCQs-Q-Button'>D.would have been</button>
      </div>
